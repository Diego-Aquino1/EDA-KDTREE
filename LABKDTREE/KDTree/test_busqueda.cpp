...
int main()
{
    ...
    int q;
    // double x1 = 810.00, y1 = 480.00, z1 = 606.00, r = 200;
    // double x1 = 124.00, y1 = 491.00, z1 = 565.00, r = 200;
    // double x1 = 16936.00, y1 = 2661.00, z1 = 6761.00, r = 2000;
    double x1 = 501.00, y1 = 524.00, z1 = 9.00, r = 9000;
    Point ans;
